...
To use these stylesheets, rename the files and robotics with the name of your theme.
...
robotics-alpha-default-narrow.css  
...
robotics-alpha-default-normal.css
...
robotics-alpha-default-wide.css
